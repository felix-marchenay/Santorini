    ...
    run () {
        return super.run(resolve => {
            this.game.setPlayers(
                new Joueur(1, 'Albert', this.game.couleursJoueur[0], new Atlas, this.game.scene, this.game.couleursHex[0]),
                new Joueur(2, 'Bertinho', this.game.couleursJoueur[1], new Poseidon, this.game.scene, this.game.couleursHex[1]),
            );
